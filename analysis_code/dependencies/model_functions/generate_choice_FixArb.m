function P_pred = generate_choice_FixArb(params, P)
...
P_pred = [LH Por ll_corr pred_ch pred_token iscorr pred_outc pred_outc_mag ActVals_obs TokVals_obs Por_obs ...
    TokVals_exp Por_exp magnitude oSPE eRPE];
end
...
shuffled_groups = sortrows([randperm(nsub)' [repmat(1:5,1,25) randi(5)]'],1);
...
%% Learning curve using simulated parameters similar across models
...
%plot learning curve, simulated parameters (100 sets)

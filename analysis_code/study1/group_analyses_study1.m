...
%Study 1, and generates plots presented in Figures 7A, 7C, 7D, S2E and S7A-D
...
%% Plot arbitration index per group (Figure 7A)
figure; hold
...
%% Plot GLM effects by OL and EL uncertainty per group (Figure 7C-D)
...
%% Plot GLM effects by reward magnitude and group (Figure S2E)
...
%load recap table
recap_table = readtable('recap_analyses_study1.csv');

%mean age per group (Figure S7A)
...
%gender distribution per group (Figure S7B)
...
%education level per group (Figure S7C)
...
%mean IQ score per group (Figure S7D)

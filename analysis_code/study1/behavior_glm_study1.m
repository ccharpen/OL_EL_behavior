...
for sub=1:nsub
    ...
    ch_OL = (past_act==1 & past_tok==-1 & P(:,14)==1) | (past_act==-1 & past_tok==1 & P(:,14)==0); %consistent with OL only
    ch_EL = (past_act==1 & past_tok==-1 & P(:,14)==0) | (past_act==-1 & past_tok==1 & P(:,14)==1); %consistent with EL only
    ...
    %2*2 breakdow, focusing on OL and EL uncertainty (trial definition)
...
%separate GLMs for each uncertainty condition (trial definition)
%OL uncertainty

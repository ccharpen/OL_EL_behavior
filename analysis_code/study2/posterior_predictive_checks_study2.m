...
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.5 1.3]); ylim([-0.5 1.3])
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5);
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.4 1.5]); ylim([-0.4 1.5])
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5);
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.5 2.2]); ylim([-0.5 2.2])
...
lsline()
xlabel('actual'); ylabel('model'); xlim([-2.5 4.2]); ylim([-2.5 4.2])
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5,'MarkerFaceColor',OL_col);
lsline()
xlabel('actual'); ylabel('model'); xlim([-1 0.3]); ylim([-1 0.3])
title(['R=',num2str(corr(diff_actual,diff_sim))]);
subplot(2,3,6); hold on
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5,'MarkerFaceColor',OL_col);
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.3 0.3]); ylim([-0.3 0.3])
title(['R=',num2str(corr(diff_actual,diff_sim))]);
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5);
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.3 0.5]); ylim([-0.3 0.5])
title(["Low vs High OL unc",['R=',num2str(corr(diff_actual,diff_sim))]]);
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5);
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.2 0.8]); ylim([-0.2 0.8])
title(["Low vs High EL unc",['R=',num2str(corr(diff_actual,diff_sim))]]);
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5,'MarkerFaceColor',OL_col);
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.3 0.8]); ylim([-0.3 0.8])
title(['R=',num2str(corr(diff_actual,diff_sim))]);
...
scatter(diff_actual,diff_sim,'filled','MarkerFaceAlpha',0.5,'MarkerFaceColor',OL_col);
lsline()
xlabel('actual'); ylabel('model'); xlim([-0.7 0.3]); ylim([-0.7 0.3])
title(['R=',num2str(corr(diff_actual,diff_sim))]);

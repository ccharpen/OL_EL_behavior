%This script performs all the behavioral (model-agnostic) analyses for Study 2 
%and generates the results presented in Tables S1 and S2, as well as 
%plots presented in: Figures 2B, 2D, 2F, 3B, 3D, S1B, S1D, S2B, S2D, and S2F.
...
%propensity to choose OL vs EL (Figure 2D)
figure;
...
%% Figure 3 plots
%2*2 breakdown - trial definition of uncertainty (Figure 3B)
figure;
...
%GLM OL and EL uncertainty - trial definition (Figure 3D)
figure;
...
%% Figure S1 plots
%2*2 breakdown - design block definition of uncertainty (Figure S1B)
figure;
...
%GLM OL and EL uncertainty - block definition (Figure S1D)
figure;
subplot(1,2,1); hold on
...
%GLM reward magnitude (Figure S2D)
figure;
